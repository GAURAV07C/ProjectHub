...
const Project3DCard = async ({
  ...
  return (
    <CardContainer className="inter- h-[20rem]">
      <Carprismaody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[24rem] h-[30rem] rounded-xl p-6 border">
        <CardItem
          translateZ="50"
